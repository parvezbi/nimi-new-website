<?php 
  ...
  if (isset($_POST['submit'])){
    ...
    if (mysqli_multi_query($conn,$deletePost)){
...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <h1 class="admin-heading" style="text-align: center;">Are you sure to delete this post?</h1>
    </div>
